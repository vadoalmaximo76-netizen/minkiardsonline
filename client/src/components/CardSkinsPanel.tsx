...
import { X, Palette, Check, ShoppingCart, Star, Sparkles, Crown } from 'lucide-react';
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {skins.map(skin => (
              ...
              >
                ...
                <div className={`w-full h-24 rounded-lg bg-gradient-to-br ${skin.backgroundGradient || getRarityColor(skin.rarity)} mb-3 flex items-center justify-center`}
                     style={{ 
