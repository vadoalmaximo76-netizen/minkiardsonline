...
export const ClashBattle: React.FC<ClashBattleProps> = ({
  ...
  const myColor = isAttacker ? 'red' : isDefender ? 'cyan' : null;
    ...
    return (
      <div className="fixed inset-0 bg-black/90 flex items-center justify-center z-[100] p-4">
        <div className="relative w-full max-w-2xl">
          ...
          <div className="relative bg-gradient-to-b from-slate-900/95 to-slate-800/95 backdrop-blur-xl rounded-2xl border border-white/10 shadow-2xl p-8">
        ...
        <div className="relative bg-gradient-to-b from-slate-900/98 to-slate-800/98 backdrop-blur-xl rounded-2xl border border-white/20 shadow-2xl p-8">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-4 mb-4">
              ...
              <h1 className="text-5xl font-black bg-gradient-to-r from-yellow-200 via-orange-400 to-red-500 bg-clip-text text-transparent tracking-wider"
                  style={{ textShadow: '0 0 30px rgba(251, 191, 36, 0.5)' }}>
                SCONTRO!
              </h1>
              <Zap className="w-10 h-10 text-yellow-400 animate-bounce" style={{ animationDelay: '0.2s' }} />
            </div>
            
            <div className="flex items-center justify-center gap-6">
              <span className="text-xl font-bold text-red-400 drop-shadow-lg">{attacker}</span>
              <span className="text-2xl font-black text-slate-500">VS</span>
              <span className="text-xl font-bold text-cyan-400 drop-shadow-lg">{defender}</span>
            </div>
          ...
          <div className="text-center mb-6">
            <div className="relative inline-block">
              <div className={`absolute inset-0 rounded-full blur-lg ${timeLeft <= 3 ? 'bg-red-500/50 animate-pulse' : 'bg-purple-500/30'}`} />
            ...
            <div className="relative h-20 rounded-xl overflow-hidden border-2 border-white/20 shadow-inner bg-slate-900">
              <div 
                ...
                style={{ 
                  ...
                  boxShadow: 'inset 0 2px 10px rgba(255,255,255,0.3), 0 0 20px rgba(239, 68, 68, 0.5)'
                }}
              >
                <div className="absolute inset-0 flex items-center pl-4">
                  <div className="flex items-center gap-3">
                    <Swords className="w-6 h-6 text-white drop-shadow-lg" />
                    <span className="text-white font-black text-xl drop-shadow-lg">{attackerTaps}</span>
                  </div>
                </div>
              ...
              <div 
                ...
                style={{ 
                  ...
                  boxShadow: 'inset 0 2px 10px rgba(255,255,255,0.3), 0 0 20px rgba(6, 182, 212, 0.5)'
                }}
              >
                <div className="absolute inset-0 flex items-center justify-end pr-4">
                  <div className="flex items-center gap-3">
                    <span className="text-white font-black text-xl drop-shadow-lg">{defenderTaps}</span>
              ...
              <div className="absolute left-1/2 top-0 w-1 h-full bg-white/50 transform -translate-x-1/2 z-10 shadow-lg" />
            </div>
            ...
            <div className="text-center">
              <div className="relative inline-block">
                ...
                <button
                  ref={buttonRef}
                  onClick={handleTap}
                  className={`relative w-52 h-52 rounded-full font-black text-3xl text-white transition-all duration-75 active:scale-90 select-none ${
                    isAttacker 
                      ? 'bg-gradient-to-br from-red-400 via-red-500 to-orange-600 shadow-xl shadow-red-500/50 hover:shadow-red-500/70 border-4 border-red-300/50' 
                      : 'bg-gradient-to-br from-cyan-400 via-cyan-500 to-blue-600 shadow-xl shadow-cyan-500/50 hover:shadow-cyan-500/70 border-4 border-cyan-300/50'
                  }`}
                  style={{ 
              ...
              <p className="text-slate-400 mt-6 text-lg animate-pulse">
          ...
          {!isParticipant && (
            <div className="text-center">
              <div className="relative inline-block">
                <div className="absolute -inset-2 bg-gradient-to-r from-purple-500/30 to-pink-500/30 rounded-xl blur" />
                <div className="relative bg-gradient-to-b from-slate-800 to-slate-900 rounded-xl p-8 border border-purple-500/30">
